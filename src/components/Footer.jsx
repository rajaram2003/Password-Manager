  ...
  return (
    <footer className="footer footer-center bg-gradient-to-r to-violet-400 from-slate-900 text-white p-10 rounded-lg">
      ...
      <nav className="flex flex-wrap justify-center gap-6 text-sm">
        ...
        <a className="hover:text-yellow-400 transition duration-300 cursor-pointer">About us</a>
        <a className="hover:text-yellow-400 transition duration-300 cursor-pointer">Contact</a>
        <a className="hover:text-yellow-400 transition duration-300 cursor-pointer">Jobs</a>
      </nav>

      {/* Social Icons */}
      <nav>
        <div className="flex justify-center gap-6 mt-5">
          <a href="#" aria-label="Twitter" className="hover:text-yellow-400 transition duration-300">
          ...
          <a href="#" aria-label="YouTube" className="hover:text-yellow-400 transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
          ...
          <a href="#" aria-label="Facebook" className="hover:text-yellow-400 transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
